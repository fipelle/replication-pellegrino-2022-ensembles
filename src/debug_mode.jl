...
compute_ep_cycle=true; equity_index_id=1; include_factor_augmentation=true; include_factor_transformations=true; regression_model=1; log_folder_path="./BC_and_EP_output";
